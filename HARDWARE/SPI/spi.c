...
{	 
 GPIO_InitTypeDef  GPIO_InitStructure;
  ...
  GPIO_Init(GPIOC, &GPIO_InitStructure);//初始化
	...
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource12,GPIO_AF_SPI3); //复用为 SPI1	MOSI
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource11,GPIO_AF_SPI3); //复用为 SPI1  MISO
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource10,GPIO_AF_SPI3); //复用为 SPI1  CLK
